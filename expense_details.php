...
<?php require_once 'expense_details_ecwc.php'; ?>
...
<div class="row">
            <div class="col-md-4">
			 <form action="expense_details_ecwc.php" method="POST">
			  <table border="0" align="center" cellpadding="0" cellspacing="0" id="tbl_budget">
			  		
<tr>
			  
  <td><label class="Title">Expense_Details_ID:</label></td>
<td><input type="text" name="expense_detail_id" class="form-control" id="expense_detail_id" placeholder="Enter expense detail id" required  value="<?php echo $expense_detail_id; ?>"></td>
...
<tr>
  <td><label class="Title">Name_Details:</label></td>
 <td><input type="text" name="name_details" class="form-control" id="name_details" placeholder="Enter expense detail name" required  value="<?php echo $expense_main_id; ?>"></td>
 </tr>		
            ...
            <div class="col-md-8">
               ...
               <?php 
                    ...
                    $result = mysqli_query($con, "SELECT * FROM expense_detail_table");
                ?>
                        ...
                        <?php 
                            ...
                            <tr>
							   <td><?php echo $row['expense_detail_id']; ?></td>
                                ...
                                <td>
                                    <a href="expense_details.php?edit=<?php echo $row['expense_detail_id']; ?>" class="btn btn-success">Update</a>
                                    <a href="expense_details_ecwc.php?delete=<?php echo $row['expense_detail_id']; ?>"  class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        <?php endwhile ?>
                    </table>
