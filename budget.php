...
<div class="header"> <h3>Budget Managemnet System </h3></div>
 ...
 <div class="import_this">
   <h4>Add Budget</h4> 
  <form method="post" action="import_file.php" enctype="multipart/form-data" class="im_file">
    <input type="file" name="excel" /> <br /> <br />
    <input type="submit" name="import"  value="import" class="this_button" />
   </form>
</div>
...
<tr>			 
 <td class="title"> Budget Amount:</td>
 <td><input type="text" name="amount_b" class="form-control" id="amount" placeholder="Enter amount" required ></td>
</tr>
                       ...
                       <thead>
                        ...
                        <?php 
                            ...
                            <tr>
                                ...
                                <td>
                                <a href="delete_budget.php?delete=<?php echo $row['budget_id'];?>"  class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
